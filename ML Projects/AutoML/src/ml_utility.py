...
#get working directory of the main.py file
...
def preprocess_data(df,target_column,scaler_type):
    ...
    if len(numerical_cols)==0:
        ...
        num_imputer = SimpleImputer(strategy='mean')  # create imputer object (will compute mean when fit)
        X_train[numerical_cols]=num_imputer.fit_transform(X_train[numerical_cols])
        X_test[numerical_cols]=num_imputer.transform(X_test[numerical_cols])


        #Scale the numerical features based on scaler_types
